...
class GitSynchronizationProvider(SynchronizationProvider):
    ...
    def connect(self) -> bool:
        ...
        try:
            if self._repo_path.exists() and (self._repo_path / ".git").exists():
                ...
                # Repository doesn't exist yet - will be cloned later
                self._repo = None
    ...
    def fetch(self) -> bool:
        ...
        if not hasattr(self._repo.remotes, 'origin') or not self._repo.remotes:
            ...
            return True  # No remote, fetch is a no-op
    ...
    def health(self) -> bool:
        ...
        try:
            ...
            # Check remote reachable (if has remote)
            try:
                ...
                self._offline = True
                # Still return True if local repo exists
