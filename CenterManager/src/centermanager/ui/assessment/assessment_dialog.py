...
class AssessmentDialog(QDialog):
    def __init__(self, assessment_service: AssessmentService, student_id: int, assessment_id: Optional[int] = None, parent: Optional[QWidget] = None) -> None:
    ...
    def _save(self) -> None:
        ...
        try:
            if self._is_edit:
                self._service.update_assessment(assessment_id=self._assessment_id, assessment_date=assessment_date, assessment_type=assessment_type, overall_score=overall_score, strengths=strengths, improvements=improvements, next_goal=next_goal, teacher_comment=teacher_comment)
            else:
                self._service.create_assessment(student_id=self._student_id, assessment_date=assessment_date, assessment_type=assessment_type, strengths=strengths, improvements=improvements, next_goal=next_goal, overall_score=overall_score, teacher_comment=teacher_comment)
            self.accept()
