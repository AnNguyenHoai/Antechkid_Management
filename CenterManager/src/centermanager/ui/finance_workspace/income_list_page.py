...
class IncomeListPage(QWidget):
    ...
    def _setup_ui(self) -> None:
        ...
        self.period_combo.addItem("Tất cả kỳ", "")
        ...
        self.date_from_edit.setSpecialValueText("Từ ngày")
        ...
        self.date_to_edit.setSpecialValueText("Đến ngày")
        ...
        clear_filter_btn = QPushButton("Xóa bộ lọc")
    ...
    def refresh(self) -> None:
        ...
        try:
            ...
            QMessageBox.critical(self, "Lỗi", "Không thể tải danh sách thu nhập.")
        finally:
            self.loading.setVisible(False)
    ...
    def _apply_filters(self) -> None:
        ...
        try:
            ...
            QMessageBox.critical(self, "Lỗi lọc", str(e))
