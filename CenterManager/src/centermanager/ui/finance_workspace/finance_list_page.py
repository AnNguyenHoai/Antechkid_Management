# -*- coding: utf-8 -*-
"""
FinanceListPage - placeholder for Income/Expense/Outstanding lists.
"""
...
class FinanceListPage(QWidget):
    def __init__(self, page_title: str, parent: Optional[QWidget] = None) -> None:
